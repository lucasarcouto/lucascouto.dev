...
export default function FooterSection({ socialLinks }: Readonly<FooterSectionProps>) {
          ...
          <div className="footer-links">
            ...
            <div className="social-links">
              {socialLinks.map(social => (
                ...
                >
                  <div className="icon-wrapper">{getIconForPlatform(social.platform)}</div>
...
function getIconForPlatform(platform: string): React.ReactNode | null {
  switch (platform) {
    case 'github':
      return (
